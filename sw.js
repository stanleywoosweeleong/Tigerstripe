// Service worker — 老虎斑 Tiger Stripe PWA. Bump CACHE_VERSION on every deploy (build.py does this automatically).
const CACHE_VERSION = 'tigerstripe-20260912-094108';
